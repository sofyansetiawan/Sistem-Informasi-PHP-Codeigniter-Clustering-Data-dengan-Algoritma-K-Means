      ...
      <div class="row">
        ...
        ?>
          ...
          <div class="table-responsive">
            ...
            <thead><tr><th>No</th><th>Nama Puskesmas</th><th>Jumlah Pasien</th><th>Ketersediaan Obat</th><th>Jumlah Fasilitas</th><th>Aksi</th></tr></thead>
            <tbody>
            ...
            <p><a href="<?=base_url();?>administrasi/data_puskesmas/del/<?=$p['no_puskesmas'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')" class="btn btn-danger " rel="tooltip" data-original-title="Menghapus Data pada baris ini" data-placement="top"><i class="fa fa-trash-o"></i> Hapus</a></p></td>
            </tr>
            <?php endforeach ?>
            </tbody>
            </table>
