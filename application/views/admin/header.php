          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
                <li><a href="<?php echo base_url(); ?>administrasi/data_obat"><i class="fa fa-tags"></i> Daftar Obat</a></li>
                <li><a href="<?php echo base_url(); ?>administrasi/data_penyakit"><i class="fa fa-tags"></i> Daftar Penyakit</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
                <li><a href="<?php echo base_url(); ?>administrasi/data_jumlah_penyakit_puskesmas"><i class="fa fa-tags"></i> Jumlah Pasien Per Puskesmas</a></li>
                <li><a href="<?php echo base_url(); ?>administrasi/data_jumlah_fasilitas_puskesmas"><i class="fa fa-tags"></i> Jumlah Fasilitas Per Puskesmas</a></li>
                <li><a href="<?php echo base_url(); ?>administrasi/data_jumlah_obat_puskesmas"><i class="fa fa-tags"></i> Jumlah Ketersediaan Obat Per Puskesmas</a></li>
              </ul>
            </li>
            </ul>
